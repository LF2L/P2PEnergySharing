...
REgenerationForecast = [gen * 6 for gen in REgenerationForecast]
...
battery_lower_bound = SOCmin*nominalCapacity *np.ones(nbOfStepInOneDay)
...
class MyProblem(Problem):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        prev_battery_values[:,0] = 0
        current_battery_values[:,0]= 0
        ...
        g2 = (X[:,:144] - loadForecast + REgenerationForecast + power_discharging_from_battery + power_charging_to_battery)**2 - threshold
